...
export function validateInterestForm() {
  ...
  pushFormElements("description", "#name", true, "Loan Product Name");
  pushFormElements("integer", "#period", true, "Loan Product Period");
  pushFormElements("", "#loanTermType", true, "Loan Term Type");
  pushFormElements("moneyAmount", "#max", true, "Maximum Loan Amount");
  pushFormElements("moneyAmount", "#min", true, "Minimum Loan Amount");
  pushFormElements("", "#rateType", true, "Rate Type");
  pushFormElements("", "#rate", true, "Interest Rate");
  pushFormElements("integer", "#compoundingFrequency", true, "Compounding Frequency");
  pushFormElements("", "#paymentFrequency", true, "Payment Frequency");
  pushFormElements("", "#disbursementType", true, "Disbursement Type");

  if (disbursement_type === "partial") {
    pushFormElements("positiveDoubleNumber", "#minimumDisbursementPercentage", true, "Minimum Disbursement Percentage");
    pushFormElements("positiveDoubleNumber", "#maximumDisbursementPercentage", true, "Maximum Disbursement Percentage");
  }

  pushFormElements("integer", "#gracePeriod", true, "Grace Period");
  pushFormElements("moneyAmount", "#accumAmount", true, "Accumulation Amount"); 
  pushFormElements("integer", "#accumDays", true, "Accumulation Days");
...
export function validateJobScheduleForm(){

   formElements = []

  let validData = false

  pushFormElements("", "#jobClass", true, "Job Class");
  pushFormElements("alphabeticStringWithSpace", "#jobName", true, "Account Name");
  pushFormElements("", "#frequency", true, "Job Frequency");
  pushFormElements("", "#runAtTime", true, "Run On Time");
