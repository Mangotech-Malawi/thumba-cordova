...
import { loadBranches } from "../services/account.js";
...
function individualParams() {
  ...
  const clientType = localStorage.getItem("clientType");
  let selectedBranchId = sessionStorage.getItem("selected_branch_id");

  if (selectedBranchId == null || typeof selectedBranchId == undefined || selectedBranchId === ""){
    selectedBranchId =  $("#branchSelector option:selected").val();
  } 
