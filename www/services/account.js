...
export function fetchBranches(table_type = null) {
...
export function loadBranches() {
    ...
    // Branch ID that was selected initially
    const selected_branch_id = sessionStorage.getItem("selected_branch_id");

    if (typeof selected_branch_id !== undefined || selected_branch_id == null || selected_branch_id === "") {
        $("#branchContainer").removeClass("d-none");
        $.when(fetchBranches()).done(function (branches) {
            const branchesArray = [];
