...
import { fetchInstallmentArrears } from "../services/installment_arrears.js";
import {  populateCollectors} from "../actions/installment_arrears.js";
import { fetchScheduledTasks } from "../services/scheduled_tasks.js";
import { recoveryCases } from "../services/collections.js";
...
$(document).ready(function () {
  ...
  $("#installment-arrears").on("click", function (e) {
    selectContent("installment_arrears");
  });
  ...
  $(document).on("click", "#shares", function (e) {
    ...
    $(document).on("click", "#recovery-cases", function (e) {
    selectContent("recovery_cases");
  });
  ...
  $("#scheduled-tasks").on("click", function(e){
...
function loadLinks(privileges) {
  ...
  // Filter and sort links based on positions
    ...
    function () {
      ...
      switch (state) {
        ...
        case "loans":
          loans.fetchLoans();
          break;
        case "installment_arrears":
          fetchInstallmentArrears();
          populateCollectors();
          break;
        case "loan_payments":
          loadLoanPayments();
